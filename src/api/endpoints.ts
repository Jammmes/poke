...
export const POKEMON_ENPOINT = (id: number) => `https://pokeapi.co/api/v2/pokemon/${id}`;
export const POKEMON_FORMS_ENPOINT = (id: number) => `https://pokeapi.co/api/v2/pokemon-form/${id}`;
